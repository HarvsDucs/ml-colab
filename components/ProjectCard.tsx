...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, isSignedIn = false }) => {
    ...
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-grow">
        ...
        {project.flowchartDescription && (
          <div className="mt-4">
            <h4 className="text-sm font-medium text-gray-900">Process Flow:</h4>
            <p className="text-sm text-gray-600">{project.flowchartDescription}</p>
          </div>
        )}
        
        <div className="mt-4">
          <h4 className="text-sm font-medium text-gray-900">Tasks Completion:</h4>
      ...
      <CardFooter className="flex justify-between">
        <Link href={isSignedIn ? `/projects/${project.id}` : "/sign-in"}>
